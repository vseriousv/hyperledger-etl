CREATE DATABASE hyperledger_development;
CREATE TABLE hyperledger_development.blocks
(
...
CREATE TABLE hyperledger_development.transactions
(
    tx_date               Date,     -- only DATE from datetime
    tx_time               DateTime, -- only TIME from datetime
...
CREATE TABLE hyperledger_development.write_set_txs
(
    tx_date        Date,     -- only DATE from datetime
    tx_time        DateTime, -- only TIME from datetime
...
CREATE TABLE IF NOT EXISTS hyperledger_development.transfers
(
    tx_date         Date,     -- only DATE from datetime
    tx_time         DateTime, -- only TIME from datetime
...
CREATE TABLE hyperledger_development.tx_transfers
(
    tx_date                          Date,          -- only DATE from datetime
    tx_time                          DateTime,      -- only TIME from datetime
...
CREATE TABLE hyperledger_development.tx_payments
(
    tx_date                          Date,          -- only DATE from datetime
    tx_time                          DateTime,      -- only TIME from datetime
...
CREATE TABLE hyperledger_development.tx_refunds
(
    tx_date              Date,          -- only DATE from datetime
    tx_time              DateTime,      -- only TIME from datetime
